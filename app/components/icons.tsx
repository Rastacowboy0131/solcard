...
export function FomoIcon({ size = 20 }: { size?: number }) {
  // fomo mark: bold italic double-loop "go" monogram
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
      <g transform="skewX(-14) translate(4 0)">
        <path
          fillRule="evenodd"
          d="M7.2 7.4c2.6-.5 4.5 1 4.5 3.5 0 3.5-2.4 6.3-5.4 6.3-1.5 0-2.3-.8-2-1.9.2-.9.9-1.4 1.8-1.4.7 0 1.2.4 1.1 1.1 0 .5-.4.8-.8.9 1.7 0 3-1.9 3-4.1 0-1.6-.9-2.5-2.2-2.2-1.1.3-2 1.2-2.5 2.7H2.9c.6-2.5 2.2-4.4 4.3-4.9zm8.3-.1c3 0 4.9 1.9 4.9 4.6 0 3-2.3 5.2-5.3 5.2s-4.9-1.9-4.9-4.6c0-3 2.3-5.2 5.3-5.2zm-.4 2.3c-1.6 0-2.7 1.2-2.7 2.8 0 1.5 1.1 2.5 2.6 2.5 1.6 0 2.7-1.2 2.7-2.8 0-1.5-1-2.5-2.6-2.5z"
        />
      </g>
    </svg>
  );
